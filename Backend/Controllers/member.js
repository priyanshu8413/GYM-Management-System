...
exports.getAllMember = async(req,res)=>{
    try{
        ...
        res.status(200).json({
            message:members.length?"Fetched Members Succcessfully":"No any Member Registered yet",
...
exports.searchMember = async(req,res)=>{
    try{
        ...
        res.status(200).json({
            message:member.length?"Fetched Members Succcessfully":"No such Member Registered yet",
            members:member,
...
exports.expiringWithin3Days= async(req,res)=>{
    try{
        ...
        res.status(200).json({
            message:member.length?"Fetched Members SuccessFully":"No Such Member is Expiring",
            members:member,
            totalMembers:member.length
        })
...
exports.expiredMember = async(req,res)=>{
    try{
        const today = new Date();
        const member =await Member.find({gym:req._id,status:"Active",
           nextBillDate:{
            $lt:today
...
exports.updateMemberPlan=async(req,res)=>{
    try{
        ...
        if(memberShip){
            ...
            await member.save()
            res.status(200).json({message:"Member Retrived Successfully",member});
